...
def main(): 
  ...
  protagonist_car = CombustionEngineCar("Godzilla", "R-34 Skyline", protagonist, "Nissan", cylinders = 6, engine_layout = "inline", octane_rating = 90)
  ...
  antagonist_car = CombustionEngineCar("Hellcat", "Challenger", antagonist, "Dodge", cylinders = 8, engine_layout = "v", octane_rating = 90, air_intake = "super-charger")
  ...
  protagonist_car.add_turbo() #TURBO UPGRADE! HP UPGRADE!
  protagonist_car.upgrade_fuel_injection() #FUEL INJECTION UPGRADE! HP UPGRADE!
  protagonist_car.upgrade_exhaust() #EXHAUST UPGRADE! HP UPGRADE!
  protagonist_car.quick_stats() #LETS VIEW HIS STATS ON HIS NEW CAR!!

  #WOW he's going to race his rival now (in the dragstrip)! Who will win??
  print(f"\n{protagonist}'s SECOND RACE!!\n")
  print(dragstrip.race_cars(protagonist_car, antagonist_car))

  #WOW the protagonist won! Who knew?? 
